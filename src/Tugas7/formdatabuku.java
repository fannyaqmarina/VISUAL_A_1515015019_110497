...
private boolean cek=true;
    ...
    private void Tampildata(){//disini method yang berisikan menyambung dengan database yang digunakan untuk menampilkan data
        try{
            String sql = "SELECT *FROM buku";//ini adalah syntak untuk melihat tampilan dari buku
    ...
    private void TambahData(String jud, String nulis, String price){//apa yang kita tuliskan ke text field judul dan combo box penulis dan field harga akan menjadi sebagai value untuk mengisi di database
        try{
...
+price+")";
    ...
    private void Hapusdata(String id, int baris){//method hapus data dimana data akan dihapus dengan mengambil id dimana datanya terclick di table.
        try{
            String sqldelete =
    ...
    private void updatedata(String jud, String nulis, String price, String id){//method mengupdate data dimana isinya mengambil id dari data yang telah terclick dan mengupdate dengan query update yang ada
         try{
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
      //saat form dijalankan maka akan menampilkan data yang telah ada
        InitTable();
      Tampildata();
    ...
    private void simpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanActionPerformed
     if(t_judul.getText().equals("")||t_harga.getText().equals("")){
         ...
         t_judul.requestFocus();//apabila field harga dan judul kosong maka akan muncul pemberitahuan bahwa masih ada data yang kosong.
     }
    ...
    private void tableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableMouseClicked
       //fungsi method ini adalah ketika kita mengklik baris yang ada di table maka pada field judul,penulis dan harga akan muncul data yang kita klik
    ...
    private void ubahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ubahActionPerformed
        //setelah kita mengklik dan mengedit data yang kita inginkan maka akan data akan terubah dan ke method updaate data tadi
        try {
             int baris = table.getSelectedRow();
  ...
  try{
    ...
    private void showActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_showActionPerformed
        //tombol tampil data agar data bisa dilihat kembali setelah di cari
        InitTable();
        Tampildata();
